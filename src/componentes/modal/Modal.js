    ...
    <div className=' max-w-800 max-h-700'>
        <div className='bg-white  flex flex-col  p-5 border-4 border-orange-700 rounded-xl '>
            <div className=' max-h-500 max-w-600 flex flex-col text-lg text-zinc-600 mb-10'>
                <div> 
                    <svg class="none" className='float-right' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <div className='w-auto max-h-600 p-4 font-medium text-center text-stone-500'>descripcion extensa de excursión
