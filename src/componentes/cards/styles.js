...
export const MODAL_PARRAFO="w-auto max-h-max px-1 font-medium text-justify text-stone-500 indent-0 m-2 mx-3 p-1 leading-6 md:leading-8 md:font-semibold md:text-2xl md:tracking-wide md:pb-2 md:mb-1";