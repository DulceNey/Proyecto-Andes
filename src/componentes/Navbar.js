      ...
      <body className="w-screen h-screen overflow-x-hidden font-semibold bg-naranja-palete text-md">
        <header class="header" className="fixed z-50 w-full h-16 p-1 bg-gris-fondo2 ">
          ...
          <div>  
            ...
            <button class="menu-btn" className="border-0 fill-naranja-palete inline-flex  p-2 pr-3 mx-0 md:pr-5" onClick={()=>setVisible(visible => !visible)}>
            { 
              visible && (
              <svg class="none" xmlns="http://www.w3.org/2000/svg"  width="34" height="34"  viewBox="0 0 24 24">
            ...
            {!visible && (
              ...
              <button className="border-0 fill-naranja-palete inline-flex p-2 pl-0 pr-3 ml-0 md:pr-5">
              <svg class="carrito" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 576 512" >
