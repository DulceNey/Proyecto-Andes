...
const ModalContainer = ({setVisibleModal,visibleCart,setvisibleCart}) => {
 
  return (
    <>
    <div className='bg-slate-300  w-5/6 h-screen float-right '>
        ...
        {visibleCart && <ShoppingCart className="float-right" setvisibleCart={setvisibleCart}/>} 
