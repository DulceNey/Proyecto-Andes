...
const ItemsCarrito = ({data,deleteFromCart,addToCart,setvisibleCart}) => {
    const {id,nombre,precio,cantidad}=data

  return (
  <>
    <div className='w-full flex flex-row justify-start gap-12 md:justify-between items-center pl-3 text-slate-900 bg-green-700 md:w-full'>
