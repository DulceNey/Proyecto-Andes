...
const ItemsCarrito = ({data,deleteFromCart,addToCart,setvisibleCart}) => {
  ...
  return (
  <>
    <div className='w-full flex flex-row justify-between items-center pl-3 text-slate-900 bg-green-700'>
    ...
    <div className=" w-16 pr-2">
        ...
        <button onClick={()=>deleteFromCart(id,true)} className="pl-10 md:pl-8" >
        ...
        <h4 className='pt-5'> ${precio * cantidad }</h4>
    </div>
