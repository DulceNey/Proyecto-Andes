...
export const Lista = () => {
  return (
    <ul className="ml-8	text-black list-disc dark:text-neutral-300">
        <li>Podrá disfrutar de vistas únicas y memorables.</li>
        ...
        <li>Horarios flexibles y asistencia al cliente disponible tanto en el momento de registrarse como durante su estadía en las instalaciones.</li>
        <Boton/>
