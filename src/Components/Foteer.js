...
<footer className="bg-gray dark:bg-gray-900">
    <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Compania</h2>
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Nuestras Redes Sociales</h2>
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
    ...
    <div Name="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com/">Andes yTurismo Group™</a>. Todos los Derechos Reservados.
        </span>
